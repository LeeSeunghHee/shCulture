...
<div class="mainBox">
	<div class="qnaSBox QnaAbox">
		...
		<div class="smBox">
			...
			<input type="text" name="title" required="required" class="qnaTi" onblur="countTitle()">
		</div>
		<textarea name="qna" required="required" class="qnaTextA qnaSubmitA" placeholder="300자 이하로 작성해주세요." onblur="countQna()"></textarea>
		</form>
	</div>
	<div id="qnaSubmitBox">
...
<script>
	...
	async function qnaSubmit(e){
		const url = cpath + '/manager/addQna';
