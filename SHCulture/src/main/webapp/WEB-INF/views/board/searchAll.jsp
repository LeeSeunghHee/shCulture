...
<div class="mainBox">
	...
	<div id="restListM">
		<div id="selectOption">${data}&ensp;(${count })</div>
		<div id="checkM">
			<div id="checkMBox">
		...
		<div id="restListB">
			<c:forEach var="rst" items="${restList}">
				<div class="restL">
					...
					<div class="restLE">&nbsp;${rst.ravg } | ${rst.international } | <span class="closeDay">${rst.closeDay }</span></div>
				</div>
			</c:forEach>
		</div>
	</div>
...
<script>
	...
	document.addEventListener('DOMContentLoaded', function() {
	    ...
	    console.log(count);
	    const restListB = document.getElementById("restListB");
	    if (restListB) { 
	        if (count === 0) {
	            restListB.style.boxShadow = 'none';
	        }
	    }
	});
	...
	async function searchOption(gunString, interString){
		...
		console.log("gun: "+gun, "inter: "+inter)
